...
class WxQyMedia extends WxQyExecute
{
    /**
     * 素材下载图片
     */
    ...
    {
        $uri = "https://qyapi.weixin.qq.com/cgi-bin/media/get?access_token=ACCESS_TOKEN&media_id=$media_id";
    ...
    {
        if (empty($path)) {
            $path = base_path() . '/storage/logs/cache/img/';
        }
        $ch = curl_init();
